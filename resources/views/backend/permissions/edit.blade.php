                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form method="POST" action="{{ route('admin.permission.update',$data->id) }}" role="form">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name ="name"  class="form-control" value="{{ $data->name }}" placeholder="Enter Latest News Title">
